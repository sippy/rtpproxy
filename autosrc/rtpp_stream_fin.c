...
static void rtpp_stream_drain_skt_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_drain_skt is called after destruction\x0a");
    abort();
}
static void rtpp_stream_finish_playback_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_finish_playback is called after destruction\x0a");
    abort();
}
static void rtpp_stream_get_actor_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_get_actor is called after destruction\x0a");
    abort();
}
static void rtpp_stream_get_proto_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_get_proto is called after destruction\x0a");
    abort();
}
static void rtpp_stream_get_rem_addr_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_get_rem_addr is called after destruction\x0a");
    abort();
}
static void rtpp_stream_get_skt_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_get_skt is called after destruction\x0a");
    abort();
}
static void rtpp_stream_get_stats_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_get_stats is called after destruction\x0a");
    abort();
}
static void rtpp_stream_guess_addr_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_guess_addr is called after destruction\x0a");
    abort();
}
static void rtpp_stream_handle_noplay_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_handle_noplay is called after destruction\x0a");
    abort();
}
static void rtpp_stream_handle_play_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_handle_play is called after destruction\x0a");
    abort();
}
static void rtpp_stream_isplayer_active_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_isplayer_active is called after destruction\x0a");
    abort();
}
static void rtpp_stream_issendable_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_issendable is called after destruction\x0a");
    abort();
}
static void rtpp_stream_locklatch_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_locklatch is called after destruction\x0a");
    abort();
}
static void rtpp_stream_prefill_addr_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_prefill_addr is called after destruction\x0a");
    abort();
}
static void rtpp_stream_reg_onhold_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_reg_onhold is called after destruction\x0a");
    abort();
}
static void rtpp_stream_rx_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_rx is called after destruction\x0a");
    abort();
}
static void rtpp_stream_send_pkt_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_send_pkt is called after destruction\x0a");
    abort();
}
static void rtpp_stream_set_skt_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_set_skt is called after destruction\x0a");
    abort();
}
static void rtpp_stream_update_skt_fin(void *pub) {
    fprintf(stderr, "Method rtpp_stream_update_skt is called after destruction\x0a");
    abort();
}
